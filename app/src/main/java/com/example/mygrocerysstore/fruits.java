...
public class fruits extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        allfruitrecycle = view.findViewById(R.id.allfruitrecycle);
        valist = new ArrayList<>();
        allvegetableadapter = new allvegetableadapter(valist,getContext());
        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(),2);
        allfruitrecycle.setLayoutManager(gridLayoutManager);
        DatabaseReference allvgrefrence = FirebaseDatabase.getInstance().getReference().child("viewallfruit");
        allfruitrecycle.setAdapter(allvegetableadapter);
